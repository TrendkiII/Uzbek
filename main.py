...
from database import init_db  # импортируем инициализацию БД
...
if __name__ == "__main__":
    ...
    try:
        ...
        # Продолжаем работу, но без БД может быть нестабильно
    ...
    with main_app.config.get('state_lock', BOT_STATE.get('state_lock', object())):
    ...
    # Небольшая задержка перед запуском Flask (для уверенности)
    time.sleep(2)
